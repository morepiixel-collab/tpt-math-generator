...
GRADE_3_CURRICULUM = {
    "3. Grade 3 Math Topics (รวมหัวข้อ ป.3)": [
        ...
        "4. Measurement",
        "5. Time",
        "6. Rounding Numbers",  # <--- เปลี่ยนเป็น Rounding Numbers
...
# ==========================================
    ...
    # ==========================================
        ...
        for i in range(10): # 10 ข้อ (5 แถว x 2 คอลัมน์)
            ...
            # กล่องเลขที่ 2
            draw_rounded_box(pdf, curr_x, start_y, w_num2, inner_h, r=4, bg_color=(255,255,255), text=str(n2), font_size=18)
        ...
        for i in range(10): # 10 ข้อ (5 แถว x 2 คอลัมน์)
            ...
            if is_nearest_10:
                ...
                while num % 100 == 0: num = random.randint(101, 999)
                ans = round(num / 100.0) * 100
                instruction = "Nearest 100"
        ...
        def draw_shape(p, stype, sx, sy, size=9):
            ...
            if stype == "circle":
                ...
                p.rect(sx, sy, size, size, style='FD')
            elif stype == "triangle":
